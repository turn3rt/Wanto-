...
class FeedController: UITableViewController {
    lazy var people = ["Natalie", "Alvaro", "Quinn", "Natalie", "Fernanda", "Cole", "Nick"]
    
    
    lazy var activities = ["Art Basel" , "Study", "Meeting", "Lunch" , "Party", "Study Aerodynamics", "Boof Seminar"]
    lazy var locations = ["Mana Convention Center", "Library West", "Little Hall" , "Chipotle", "The Standard", "Marston Science Library", "Uranus"]
